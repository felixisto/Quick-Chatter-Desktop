...
import utilities.StringFormatting;
...
public class BCTransmissionMessageSegment {
    ...
    public static @NotNull BCTransmissionMessageSegment build(@NotNull byte[] bytes) {
        return new BCTransmissionMessageSegment(bytes);
    }
    ...
    BCTransmissionMessageSegment(@NotNull byte[] data) {
        this.data = data;
    ...
    public int headerValueAsSizeValue() throws BEError {
        ...
        String valueAsString = BCTransmissionMessageSegment.bytesToString(value);
