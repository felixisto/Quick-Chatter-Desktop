...
import network.basic.ScannerConfiguration;
...
import network.bluetooth.bluecove.model.BCDiscoveredClient;
import network.bluetooth.bluecove.parser.BluetoothDeviceToClientParser;
