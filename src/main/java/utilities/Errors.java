...
public class Errors {
    ...
    public static void throwUnsupportedOperation(@NotNull String description) throws RuntimeException
    {
        throw new UnsupportedOperationException(description);
    }
    ...
    public static void throwTimeoutError(@NotNull String description) throws Exception
    {
        throw new Exception(description);
    }
}
