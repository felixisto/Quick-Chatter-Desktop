...
public class BDStandardReadWriteBandwidthMonitor extends BDStandardReadWriteBandwidth implements StreamBandwidth.Tracker.Monitor {
    ...
    public BDStandardReadWriteBandwidthMonitor(@NotNull DataSize flushDataRate) {
        this(flushDataRate, DEFAULT_FORCE_FLUSH_TIME);
    }

    public BDStandardReadWriteBandwidthMonitor(@NotNull DataSize flushDataRate, @NotNull TimeValue forceFlushTime) {
