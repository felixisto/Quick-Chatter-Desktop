...
import quickchatter.network.bluetooth.bluecove.model.BDDiscoveredClient;
...
public class BDClientScanner implements BEClientScanner, LooperClient {
    ...
    private final @NotNull HashSet<BDDiscoveredClient> _clients = new HashSet<>();
    ...
    public BDClientScanner(@NotNull BDDiscovery discovery, @NotNull Parser<RemoteDevice, BEClient> parser) {
        _discovery = discovery;
        _parser = parser;
    }

    public BDClientScanner(@NotNull BDDiscovery discovery) {
    ...
    public boolean isClientConsideredTimedOut(@NotNull BDDiscoveredClient client, @NotNull Date now) {
    ...
    private @NotNull Set<BDDiscoveredClient> addNewClients(@NotNull Set<BDDiscoveredClient> clients) {
...
class ScanUpdateResult {
    final @NotNull Set<BDDiscoveredClient> allClients;
    final @NotNull Set<BDDiscoveredClient> newClients;
    final @NotNull Set<BDDiscoveredClient> clientsLost;

    ScanUpdateResult(@NotNull Set<BDDiscoveredClient> allClients,
                     @NotNull Set<BDDiscoveredClient> newClients,
                     @NotNull Set<BDDiscoveredClient> clientsLost) {
