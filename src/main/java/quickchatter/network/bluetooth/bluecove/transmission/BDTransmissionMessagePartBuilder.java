...
public class BDTransmissionMessagePartBuilder {
    public static final @NotNull TransmissionType PING_TYPE = BDConstants.getShared().TYPE_PING;

    public final @NotNull TransmissionType type;

    public BDTransmissionMessagePartBuilder(@NotNull TransmissionType type) {
        this.type = type;
    }
